// GASDRIVE PLUS V7.13 - 380 PREGUNTAS DGT 2026
const VERSION = "7.13";
...
const SITUACIONES = {
  clima: [
    ...
    {q:"Niebla espesa: ¿Qué luces usas?",a:["Largas","Antiniebla delanteras y traseras","Ninguna"],ok:1},
    {q:"Hielo en la calzada. ¿Qué haces?",a:["Frenar fuerte","Conducir suave sin movimientos bruscos","Acelerar"],ok:1},
...
function init() {
  console.log("GasDrive Plus V7.13 cargado");
  actualizarCoins();
...
// Llama a notifRecordatorio24h() cada vez que abra la app
